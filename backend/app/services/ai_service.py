...
Version: Comprehensive Investment Plans
"""
...
class AIService:
    """AI Service ที่แนะนำการลงทุนครอบคลุมตามระดับรายได้"""
...
- SSF: เหลือ {remaining_ssf:,.0f} บาท (สูงสุด {max_ssf:,.0f})
...
9. สำหรับรายได้สูง (1,500,000+): ควรมีเงินบริจาคการศึกษา (นับ 2 เท่า)
...
{{
  "plans": [
    ...
    {{
      ...
      "plan_type": "{risk_level}",
      "description": "กระจายความเสี่ยง เน้น RMF + SSF",
      ...
      "allocations": [
        ...
        {{
          ...
          "tax_saving": 10000,
          "risk_level": "{risk_level}",
          "pros": ["ยืดหยุ่นกว่า RMF", "ไม่ต้องซื้อทุกปี"],
          "cons": ["ต้องถือครบ 10 ปี", "วงเงินจำกัด 200,000"]
        }},
        {{
          "category": "ประกันชีวิต",
    ...
    {{
      ...
      "allocations": [
        ...
        {{
          "category": "SSF",
          "investment_amount": {int(min(max_ssf, suggested_max * 0.15))},
          "percentage": 15.0,
          "tax_saving": {int(min(max_ssf, suggested_max * 0.15) * marginal_rate / 100)},
          "risk_level": "{risk_level}",
          "pros": ["ยืดหยุ่น", "ลดหย่อนได้ดี"],
          "cons": ["ต้องถือ 10 ปี"]
        }},
        {{
        ...
        {{
          "category": "เงินบริจาคการศึกษา (นับ 2 เท่า)",
          "investment_amount": {int(suggested_max * 0.10) if gross >= 1500000 else 0},
          "percentage": 10.0,
          "tax_saving": {int(suggested_max * 0.10 * 2 * marginal_rate / 100) if gross >= 1500000 else 0},
          "risk_level": "low",
          "pros": ["ลดหย่อนนับ 2 เท่า", "ช่วยเหลือสังคม", "คุ้มมาก"],
          "cons": ["ไม่มีผลตอบแทนทางการเงิน"]
        }}
      ]
    }}
  ]
